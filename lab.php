...
<!-- Begin Page Content -->
  ...
  <!-- Page Heading -->
          <h1 class="h3 mb-0 text-gray-800">List of Lab</h1>
          <a href="manageLab.php" style="position: absolute; right:10px; top:90px; width:120px" class="btn btn-primary btn-user btn-block">Manage Lab</a>
            ...
            <img src="lab.jpg" width="250px" height="120px"></img><br><br>
                  <table  width="100%">
                    <tr>
                      <td width="50%"><b>Lab Information</b></td>
                      <td width="10%"></td>
                      <td width="40%"><b>Reserve Lab</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td></td>
                      <td></td>
                      <td><br></br><a href="" style="position: absolute; right: 20px; bottom:10px"class="btn btn-primary">Reserve</a></td>
                    </tr>
                  </table>
                </div>
              </div>
            ...
            <div style="margin: auto; width: 90%; padding: 10px;" class="col-xl-10 col-lg-9">
              <div class="card shadow mb-4">
            <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Lab B</h6>
                </div>
                <div class="card-body">
            <img src="lab.jpg" width="250px" height="120px"></img><br><br>
                  <table  width="100%">
