...
<title>Edit Research Assistance</title>
			
			<div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Edit Research Assistance</h1>
                <hr><br>
              </div>
			<form class="user">
                ...
                <a href="manageAssistance.php" style="position: absolute; right: 130px;"class="btn btn-primary">
                  Submit
                </a>
