...
<title>Research Publication</title>
			...
			<div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Edit Research Publication</h1>
                <hr><br>
              </div>
			<form class="user">
                ...
                <a href="researchPublication.php" style="position: absolute; right: 50px;"class="btn btn-primary">
                  Cancel
                </a>
                <a href="publicationProject.php" style="position: absolute; right: 130px;"class="btn btn-primary">
                  Submit
                </a>
              </form>
            </div>
