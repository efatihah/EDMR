...
<title>Raw Data</title>
			...
			<form class="user">
                <div class="form-group">
                    <select class="form-control" id="accesibleType">
                ...
                <div class="form-group">
                  <input type="file" class="form-control" id="exampleInput" placeholder="">
                </div>
                ...
                <a href="rawProject.php" style="position: absolute; right: 50px;"class="btn btn-primary">
                  Submit
                </a>
              </form>
            </div>
