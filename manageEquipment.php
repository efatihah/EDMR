...
<!-- Begin Page Content -->
  ...
  <!-- Page Heading -->
          ...
          <a href="addEquipment.php" style="position: absolute; right:10px; top:88px; width:80px" class="btn btn-primary btn-user btn-block">Add</a>
                ...
                <div class="card-body">
                  ...
                  <div class="btn-group" style="position: absolute; right:30px; bottom:10px; width:80px">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="editEquipment.php">Edit</a>
